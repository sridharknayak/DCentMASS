...
<div class="col-md-2">
<div class="sridhar-card3 card">
 <!--  <div style="background-color:#3EB6C2" class="card-body"><br> -->

    <br><img src="images/career counselling5.png" class="img-fluid"> <br><br>
    
    <p><center> The Best WAY to PREDICT the FUTURE is to CREATE IT</p> <br><br>

    <p> Take Another Step In Your Journey</p></center> <br>
    <img src="images/career counselling.png" class="img-fluid"> 
