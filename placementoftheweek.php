...
<span class="bgtext">Placement of the Week</span>
    ...
    <iframe width="320" height="250" src="https://www.youtube.com/embed/-qsYLHtT-JQ?autoplay=0">
    </iframe>

    <iframe width="320" height="250" src="https://www.youtube.com/embed/YixNnWMT7y8?autoplay=0">
    </iframe> <br><br>

    <img src="images/placement3.png" class="img-fluid"/><br><br><br>
...
<div class="col-md-2"> 
    <div class="sridhar-card5 card">
     <!--  <div style="background-color:#3EB6C2" class="card-body"><br> -->
        ...
        <p>&nbsp; New results.</p>
        <br><br><br><br><br>
        <img src="images/placement2.png" class="img-fluid"> 
